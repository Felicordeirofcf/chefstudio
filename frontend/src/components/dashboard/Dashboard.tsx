...
import { createAdCampaign, getMenuItems } from "../../lib/api";
...
export default function Dashboard() {
  ...
  const handleCreateCampaign = async () => {
    ...
    try {
      const campaignConfig = { budget, radius: localRadius };
      const response = await createAdCampaign(campaignConfig);
      setCampaignMessage(response.message || "Campanha criada com sucesso!");
      toast({ title: "Sucesso!", description: response.message || "Campanha inteligente criada." });
  ...
  // Simulated results based on budget
  ...
  return (
    <div className="p-4 sm:p-8 space-y-8">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        <Card>
          <CardHeader><CardTitle className="text-sm font-medium">Métrica 1</CardTitle></CardHeader>
        ...
        <Card>
          <CardHeader><CardTitle className="text-sm font-medium">Métrica 2</CardTitle></CardHeader>
        ...
        <Card>
          <CardHeader><CardTitle className="text-sm font-medium">Métrica 3</CardTitle></CardHeader>
        ...
        <Card>
          <CardHeader><CardTitle className="text-sm font-medium">Métrica 4</CardTitle></CardHeader>
